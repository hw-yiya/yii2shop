    ...
    <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
        ...
        <div class="cat_bd">
            <?php foreach ($categories as $category):?>
                <div class="cat item1">
                    <h3><?=$category->name?> <b></b></h3>
                    <div class="cat_detail">
                        <?php foreach ($category->children as $child):?>
                            <dl class="dl_1st">
                                <dt>
                                    <?=Html::a($child->name,['goods/list','id'=>$child->id])?>
                                </dt>

                                <dd>
                                    <?php foreach ($child->children as $child2):?>
                                        <?=Html::a($child2->name,['goods/list','id'=>$child2->id])?>
                                    <?php endforeach;?>
                                </dd>
                            </dl>
                        <?php endforeach;?>
        ...
        <div class="service mt10">
            ...
            <div class="service_wrap">
                ...
                <div class="lottery none">
                    <p><a href=""><?=Html::img('@web/images/lottery.jpg')?></a></p>
                </div>
                <!-- 彩票 end -->
    ...
    <div class="floor_left fl">
        ...
        <div class="cate fl">
            ...
            <div class="cate_wrap">
                ...
                <p><a href=""><a href=""><?=Html::img('@web/images/notebook.jpg')?></a></p>
            </div>
