...
<div class="main w1210 mt10 bc">
    ...
    <div class="breadcrumb">
        <h2>当前位置：<?=Html::a('首页',['index/index'])?> > <?=Html::a($goods_cate->name,['goods/list','id'=>$goods_cate->id])?> > <?=$goods->name?></h2>
    </div>
    <!-- 面包屑导航 end -->
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href=""><img src="<?=$goods->logo?>" width="350px" height="350px"></a><!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
              <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                        <?php foreach ($goodsimgs as $img):?>

                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><img src="<?=$img->path?>"></a>
                            </li>
            ...
            <div class="detail_bd">
                ...
                <div class="comment detail_div mt10">
                    ...
                    <div class="comment_items mt10">
                        <div class="user_pic">
                            <dl>
                                <dt><a href=""><?=Html::img('@web/images/user1.jpg') ?></a></dt>
                                <dd><a href="">乖乖</a></dd>
                            </dl>
                        </div>
                        <div class="item">
